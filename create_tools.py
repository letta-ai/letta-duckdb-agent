...
agent = client.agents.create(
    memory_blocks=[
        {"label": "human", "value": "The user a credit risk analyst at Citi Bank."}, 
        {"label": "persona", "value": instructions}
    ],
    tool_ids=[execute_sql_tool.id, show_table_schemas_tool.id, execute_sql_multiple_tool.id, generate_final_report_tool.id, run_code_with_queries_tool.id],
    #tools=["run_code"],
